...
public class InstantiationWithGenericsExpressionTest {
	...
	@Test
	public void testConstructorUnary(SessionFactoryScope scope) {
		scope.inTransaction( session -> assertThat( session.createQuery(
	...
	@Test
	public void testImplicitConstructorUnary(SessionFactoryScope scope) {
		scope.inTransaction( session -> assertThat( session.createQuery(
	...
	@Test
	public void testInjectionUnary(SessionFactoryScope scope) {
		scope.inTransaction( session -> assertThat( session.createQuery(
